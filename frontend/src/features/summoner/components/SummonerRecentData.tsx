            ...
            <div className='flex'>
                <div className='flex p-4 gap-4 items-end'>
                    <div className='flex flex-col w-fit items-center' >
                        ...
                        <span className='w-6 bg-amber-400' style={{ height: `${laneData.TOP < 1 ? 4 : (calculateMaxHeight().TOP)}px` }}></span>
                        <p className='text-xs mt-1'>Top</p>
                    </div>
                    <div className='flex flex-col w-fit items-center' >
                        <p className='text-xs'>{laneData.JUNGLE}</p>
                        <span className='w-6 bg-green-400' style={{ height: `${laneData.JUNGLE < 1 ? 4 : (calculateMaxHeight().JUNGLE)}px` }}></span>
                        <p className='text-xs mt-1'>Jungle</p>
                    </div>
                    <div className='flex flex-col w-fit items-center' >
                        <p className='text-xs'>{laneData.MIDDLE}</p>
                        <span className='w-6 bg-cyan-400' style={{ height: `${laneData.MIDDLE < 1 ? 4 : (calculateMaxHeight().MIDDLE)}px` }}></span>
                        <p className='text-xs mt-1'>Mid</p>
                    </div>
                    <div className='flex flex-col w-fit items-center' >
                        <p className='text-xs'>{laneData.BOTTOM}</p>
                        <span className='w-6 bg-red-400' style={{ height: `${laneData.BOTTOM < 1 ? 4 : (calculateMaxHeight().BOTTOM)}px` }}></span>
                        <p className='text-xs mt-1'>Adc</p>
                    </div>
                    <div className='flex flex-col w-fit items-center' >
                        <p className='text-xs'>{laneData.UTILITY}</p>
                        <span className='w-6 bg-blue-400' style={{ height: `${laneData.UTILITY < 1 ? 4 : (calculateMaxHeight().UTILITY)}px` }}></span>
