...
function App() {
  return (
    <main className="flex justify-center m-2 mt-6">
      <div className='text-center'>
          <h1 className='flex flex-col text-5xl font-title text-shadow-md mt-20 mb-6 text-shadow-green-400'>
          DOMINATE THE
          <span className='text-green-400 mt-4'>RIFT</span> 
          </h1>
