  ...
  return (
    <main className="flex justify-center m-10 mt-6">
      <div className='text-center'>
          <h1 className={`flex flex-col text-5xl font-title text-shadow-md mt-20 mb-6 text-shadow-${primaryColor}-400`}>
          DOMINATE THE
          <span className={`text-${primaryColor}-400 mt-4`}>RIFT</span> 
          </h1>
